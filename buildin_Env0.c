 ...
 *
 * Description: prints one variable per line in the format 'variable' is equal to 'value'.
 */
int command_handler_env(char **args, char __attribute__((__unused__)) **front)
{
int index;
...
/**
 * command_handler_setenv - add an environmental variable to the path.
 * @args: An array of arguments passed to the shell.
 * @front: A double pointer to the beginning of args.
...
/**
 * command_handler_unsetenv - del an env variable from the path.
 * @args: An array of arguments passed to the shell.
 * @front: A double pointer to the beginning of args.
